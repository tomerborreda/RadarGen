...
class DPM_Solver:
    ...
    def data_prediction_fn(self, x, t):
        ...
        # Note: For marigold with flow-dpm-solver++ the x0 calculation is just equal to x0 = x - sigma_t * model_output
        # Where model_output is the output of the model which is called inside self.noise_prediction_fn
        # self.visualize_x0(x0.clone().detach(), t)
